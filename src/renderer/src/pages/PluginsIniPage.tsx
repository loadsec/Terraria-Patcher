    ...
    <div className="min-h-full flex flex-col gap-6 animate-in fade-in duration-300">
      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div>
          ...
          <p className="text-[10px] text-muted-foreground/50 mt-1.5 pl-6 font-mono break-all">
              ...
              <div className="px-4 py-3 border-b bg-muted/10">
                <div className="flex items-center justify-between gap-2">
                  <div className="min-w-0">
                    ...
                    <div className="text-[10px] font-mono text-muted-foreground/50 break-all mt-0.5">
                      [{section.name}]
                    </div>
                  </div>
